        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div class="lg:col-span-5 space-y-5">
                    ...
                    <div
                        class="p-6 rounded-[24px] border border-[#34C759]/25 bg-[#34C759]/[0.05] dark:bg-[#30D158]/[0.08] space-y-4 shadow-sm">
                        <div class="flex items-center gap-3.5">
                            <div
                                class="w-12 h-12 rounded-[16px] bg-[#34C759]/15 text-[#34C759] dark:text-[#30D158] flex items-center justify-center shrink-0">
                        ...
                        <p class="text-xs text-[#1D1D1F]/75 dark:text-[#F5F5F7]/75 leading-relaxed">
                            Layanan konsultasi cepat via pesan WhatsApp. Respon cepat oleh tim support teknis pada jam kerja
                            (08.00 - 20.00 WIB).
                        </p>
                        <a href="https://wa.me/{{ $officialWhatsappRaw }}?text=Halo%20Tim%20Cooca%20UMKM,%20saya%20butuh%20bantuan%20seputar%20aplikasi"
                            target="_blank" rel="noopener"
                            class="w-full py-3.5 rounded-[14px] bg-[#34C759] hover:bg-[#2DB84D] text-white font-semibold text-xs flex items-center justify-center gap-2 shadow-sm active:scale-[0.98] transition-all">
                    ...
                    <!-- Email Card -->
                    <div
                        class="bg-white dark:bg-[#1C1C1E] border border-black/[0.06] dark:border-white/[0.08] p-6 rounded-[24px] space-y-2.5 shadow-sm">
                        <div class="flex items-center gap-3.5">
                            <div
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-3.5">
                            <div
                                class="w-10 h-10 rounded-[14px] bg-black/[0.04] dark:bg-white/[0.06] text-[#1D1D1F] dark:text-[#F5F5F7] flex items-center justify-center shrink-0">
                ...
                <div
                    class="lg:col-span-7 bg-white dark:bg-[#1C1C1E] border border-black/[0.06] dark:border-white/[0.08] p-6 sm:p-8 rounded-[28px] shadow-sm">
                    <div class="space-y-1 mb-6">
                        <h3 class="text-xl font-bold text-[#1D1D1F] dark:text-[#F5F5F7]">Kirim Pesan Langsung</h3>
                        <p class="text-xs text-[#6E6E73] dark:text-[#86868B]">Isi formulir di bawah ini dan kami akan segera
                            membalas via WhatsApp atau Email.</p>
                    </div>

                    @if (session('success_message'))
                        <div
                            class="p-4 rounded-[16px] bg-[#34C759]/10 border border-[#34C759]/20 text-[#34C759] dark:text-[#30D158] text-xs mb-6 flex items-center gap-3">
                    ...
                    <form action="{{ route('contact.submit') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            <label class="block text-xs font-semibold text-[#1D1D1F] dark:text-[#F5F5F7] mb-1.5">Pesan /
                                Kendala Anda *</label>
