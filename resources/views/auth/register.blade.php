@extends('layouts.guest', ['title' => 'Daftar Bisnis Baru — Cooca UMKM'])
        ...
        <div
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="phone"
                            class="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-1.5">Nomor WhatsApp / HP</label>
