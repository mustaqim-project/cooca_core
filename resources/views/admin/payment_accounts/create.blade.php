        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <textarea name="instructions" rows="3" placeholder="Contoh: Transfer tepat hingga 3 digit terakhir ke rekening BCA resmi Cooca, lalu upload bukti struk transfer."
                          class="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 focus:border-indigo-500 rounded-xl text-white text-xs leading-relaxed">{{ old('instructions') }}</textarea>
