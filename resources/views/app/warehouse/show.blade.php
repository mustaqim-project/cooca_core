...
@section('content')
    <div class="max-w-[1360px] mx-auto space-y-6 pb-12" x-data="{
        ...
        <div class="overflow-x-auto pb-1 scrollbar-none">
            <div
                class="inline-flex p-1 rounded-[11px] bg-black/[0.05] dark:bg-white/[0.07] border border-black/5 dark:border-white/10 text-[13px] font-medium whitespace-nowrap">
                <a href="{{ route('warehouse.index') }}"
                    ...
                    <svg class="w-4 h-4 text-black/40 dark:text-white/40" fill="none" stroke="currentColor"
                ...
                <a href="{{ route('inventory.stocks') }}?location_id={{ $location->id }}"
                    ...
                    <svg class="w-4 h-4 text-[#007AFF]" fill="none" stroke="currentColor" stroke-width="1.8"
                        viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span
                        class="px-1.5 py-0.2 rounded-full text-[11px] tabular-nums font-semibold bg-[#007AFF]/12 text-[#007AFF]">{{ $stocks->total() }}</span>
                </a>
        ...
        {{-- ===================================================== --}}
        <header
            class="rounded-[14px] backdrop-blur-md bg-white/75 dark:bg-[#1C1C1E]/75 border border-black/5 dark:border-white/10 px-4 sm:px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div class="flex items-start sm:items-center gap-3.5">
                {{-- Location Icon Tile --}}
                <div
                    class="w-11 h-11 rounded-[12px] flex items-center justify-center shrink-0
                @if ($location->type === 'warehouse') bg-[#007AFF]/10 text-[#007AFF]
                @elseif($location->type === 'central_kitchen')
                    bg-[#FF9500]/10 text-[#FF9500]
                @else
                    bg-[#34C759]/10 text-[#34C759] @endif
            ">
                ...
                <div>
                    ...
                    <nav class="flex items-center gap-1.5 text-[12px] text-black/50 dark:text-white/50 mb-0.5">
                        <a href="{{ route('warehouse.index') }}" class="hover:text-[#007AFF] transition-colors">Gudang &amp;
                            Lokasi</a>
                        <span>›</span>
                    ...
                    <div class="flex items-center gap-2 flex-wrap">
                        ...
                        @if ($location->type === 'warehouse')
                            <span
                                class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-semibold bg-[#007AFF]/12 text-[#007AFF]">
                                Gudang
                            </span>
                        @elseif($location->type === 'central_kitchen')
                            <span
                        ...
                        @if ($location->code)
                            <span
                                class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-mono tabular-nums font-semibold bg-black/[0.05] dark:bg-white/[0.08] text-black/60 dark:text-white/60">
                                {{ $location->code }}
                            </span>
                        @endif
                        ...
                        @if ($location->is_primary)
                            <span
                                class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-semibold bg-[#5856D6]/12 text-[#413FA6] dark:text-[#5E5CE6]">
                                Lokasi Utama
                            </span>
                        @endif
                        ...
                        @if ($location->is_active)
                            <span
                                class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-semibold bg-[#34C759]/12 text-[#248A3D] dark:text-[#30D158]">
                                <span class="w-1.5 h-1.5 rounded-full bg-[#34C759]"></span> Aktif
                            </span>
                        @else
                            <span
                                class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-semibold bg-black/[0.06] dark:bg-white/[0.08] text-black/55 dark:text-white/55">
            ...
            <div class="flex items-center gap-2 w-full sm:w-auto flex-wrap">
                <a href="{{ route('warehouse.index') }}"
                    ...
                    <svg class="w-4 h-4 text-black/50 dark:text-white/50" fill="none" stroke="currentColor"
        ...
        <div class="p-4 rounded-[14px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5">
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 text-[13px]">
                <div class="flex items-start gap-2.5">
                    <div
                        class="w-7 h-7 rounded-[8px] bg-black/[0.04] dark:bg-white/[0.06] flex items-center justify-center shrink-0 text-black/50 dark:text-white/50">
                    ...
                    <div>
                        <span
                            class="text-[11px] text-black/40 dark:text-white/40 uppercase font-semibold tracking-wide block">Alamat
                            Fisik</span>
                ...
                <div class="flex items-start gap-2.5">
                    ...
                    <div>
                        <span
                            class="text-[11px] text-black/40 dark:text-white/40 uppercase font-semibold tracking-wide block">Kontak
                            / Telepon</span>
                ...
                <div class="flex items-start gap-2.5">
                    ...
                    <div>
                        <span
                            class="text-[11px] text-black/40 dark:text-white/40 uppercase font-semibold tracking-wide block">Terdaftar
                            Sejak</span>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <div
                ...
                <div class="mt-2 flex items-baseline justify-between">
                    <span
                        class="text-[24px] font-bold tabular-nums text-black dark:text-white">{{ $stocks->total() }}</span>
            ...
            <div
                ...
                <div class="mt-2 flex items-baseline justify-between">
                    <span
                        class="text-[22px] sm:text-[24px] font-bold tabular-nums text-[#34C759] dark:text-[#30D158] truncate">
            ...
            <div
                ...
                <div class="mt-2 flex items-baseline justify-between">
                    <span
                        class="text-[24px] font-bold tabular-nums {{ $lowStockCount > 0 ? 'text-[#FF9500] dark:text-[#FF9F0A]' : 'text-black dark:text-white' }}">
                        {{ $lowStockCount }}
                    </span>
                    <span
                        class="text-[11px] {{ $lowStockCount > 0 ? 'text-[#FF9500] dark:text-[#FF9F0A] font-medium' : 'text-black/40 dark:text-white/40' }}">
            ...
            <div
                ...
                <div class="mt-2 flex items-baseline justify-between">
                    <span
                        class="text-[24px] font-bold tabular-nums text-[#5856D6] dark:text-[#5E5CE6]">{{ $receipts->count() }}</span>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
            <a href="{{ route('purchase-orders.index') }}?po_type=supplier"
                ...
                <div
                    class="w-10 h-10 rounded-[10px] bg-[#FF9500]/10 text-[#FF9500] flex items-center justify-center shrink-0">
                ...
                <div>
                    <h4
                        class="font-semibold text-[14px] text-black dark:text-white group-hover:text-[#007AFF] transition-colors">
            ...
            <a href="{{ route('inventory.opnames.index') }}"
                class="p-4 rounded-[14px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 hover:shadow-[0_4px_20px_rgba(0,0,0,0.04)] active:scale-[0.98] transition-all flex items-center gap-3.5 group">
                <div
                    class="w-10 h-10 rounded-[10px] bg-[#AF52DE]/10 text-[#AF52DE] flex items-center justify-center shrink-0">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z" />
                    </svg>
        ...
        <div class="rounded-[14px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 overflow-hidden">
            <div
                class="p-4 border-b border-black/5 dark:border-white/10 flex items-center justify-between flex-wrap gap-3">
                <div>
                    <h3 class="text-[15px] font-semibold text-black dark:text-white">Daftar Stok Produk di Lokasi Ini</h3>
                    <p class="text-[12px] text-black/50 dark:text-white/50">Kuantitas aktual fisik dan estimasi nilai
                        persediaan</p>
                </div>
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    <div class="relative w-48 sm:w-64">
                        <svg class="w-3.5 h-3.5 text-black/35 dark:text-white/35 absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none"
                            ...
                            <tr x-show="!searchStock || '{{ strtolower($stock->product?->name . ' ' . $stock->product?->code . ' ' . ($stock->product?->category?->name ?? '')) }}'.includes(searchStock.toLowerCase())"
                                ...
                                <td class="px-4 py-3">
                                    ...
                                    @if ($stock->product?->code)
                                        <div class="text-[11px] font-mono tabular-nums text-black/45 dark:text-white/45">
                                ...
                                <td class="px-4 py-3 text-right">
                                    <span
                                        class="font-semibold tabular-nums text-[14px] {{ $isLow ? 'text-[#FF9500] dark:text-[#FF9F0A]' : 'text-black dark:text-white' }}">
                                        {{ number_format($stock->quantity, 2) }}
                                    </span>
                                    <span
                                        class="text-[11px] text-black/40 dark:text-white/40 ml-0.5">{{ $stock->product?->outputUnit?->symbol ?? '' }}</span>
                                </td>
                                ...
                                <td
                                    class="px-4 py-3 text-right font-mono tabular-nums font-semibold text-[#34C759] dark:text-[#30D158]">
                                    Rp {{ number_format($valuation, 0, ',', '.') }}
                                </td>
                                <td class="px-4 py-3 text-center">
                                    @if ($isLow)
                                        <span
                                            class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-semibold bg-[#FF9500]/12 text-[#B25E00] dark:text-[#FF9F0A]">
                                            <span class="w-1.5 h-1.5 rounded-full bg-[#FF9500]"></span> Hampir Habis
                                        </span>
                                    @elseif($stock->quantity <= 0)
                                        <span
                                            class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[11px] font-semibold bg-[#FF3B30]/12 text-[#C41E17] dark:text-[#FF453A]">
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="py-12 text-center text-black/50 dark:text-white/50">
                                    <div
                                        class="w-12 h-12 rounded-full bg-black/[0.04] dark:bg-white/[0.06] flex items-center justify-center mx-auto mb-2 text-black/30 dark:text-white/30">
                                    ...
                                    <div class="font-semibold text-black dark:text-white text-[14px]">Belum ada stok fisik
                                        di gudang ini</div>
                                    <div class="text-[12px] text-black/45 dark:text-white/45 mt-1 max-w-sm mx-auto">
                                        Lakukan penerimaan barang dari Purchase Order Supplier atau transfer stok dari
                                        cabang lain.
                                    </div>
                                </td>
                            </tr>
            ...
            <div class="sm:hidden divide-y divide-black/[0.04] dark:divide-white/[0.06]">
                @forelse($stocks as $stock)
                    ...
                    <div x-show="!searchStock || '{{ strtolower($stock->product?->name . ' ' . $stock->product?->code . ' ' . ($stock->product?->category?->name ?? '')) }}'.includes(searchStock.toLowerCase())"
                        class="p-3.5 space-y-2.5 active:bg-black/[0.02] dark:active:bg-white/[0.03] transition-colors {{ $isLow ? 'bg-[#FF9500]/5' : '' }}">
                        <div class="flex items-start justify-between gap-2">
                            <div>
                                <h4 class="font-semibold text-[14px] text-black dark:text-white">
                            ...
                            <div>
                                @if ($isLow)
                                    <span
                                        class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-[#FF9500]/12 text-[#B25E00] dark:text-[#FF9F0A]">
                                        <span class="w-1.5 h-1.5 rounded-full bg-[#FF9500]"></span> Hampir Habis
                                    </span>
                                @elseif($stock->quantity <= 0)
                                    <span
                                        class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-[#FF3B30]/12 text-[#C41E17] dark:text-[#FF453A]">
                                        <span class="w-1.5 h-1.5 rounded-full bg-[#FF3B30]"></span> Habis
                                    </span>
                                @else
                                    <span
                                        class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-[#34C759]/12 text-[#248A3D] dark:text-[#30D158]">
                                        <span class="w-1.5 h-1.5 rounded-full bg-[#34C759]"></span> Tersedia
                                    </span>
                                @endif
                            </div>
                        ...
                        <div
                            class="grid grid-cols-2 gap-2 text-[12px] bg-black/[0.02] dark:bg-white/[0.02] p-2.5 rounded-[10px]">
                            <div>
                                <span
                                    class="text-[10px] uppercase font-semibold text-black/40 dark:text-white/40 block">Stok
                                    Aktual</span>
                                <span
                                    class="tabular-nums font-bold text-[14px] {{ $isLow ? 'text-[#FF9500] dark:text-[#FF9F0A]' : 'text-black dark:text-white' }}">
                                    {{ number_format($stock->quantity, 2) }}
                                </span>
                                <span
                                    class="text-[10px] text-black/40 dark:text-white/40">{{ $stock->product?->outputUnit?->symbol ?? '' }}</span>
                            </div>
                            <div>
                                <span
                                    class="text-[10px] uppercase font-semibold text-black/40 dark:text-white/40 block">Min.
                                    Stok</span>
                            ...
                            <div>
                                <span
                                    class="text-[10px] uppercase font-semibold text-black/40 dark:text-white/40 block">HPP
                                    / Unit</span>
                                <span class="tabular-nums text-black/60 dark:text-white/60">
                                    Rp {{ number_format($stock->last_cost, 0, ',', '.') }}
                                </span>
                            </div>
                            <div>
                                <span
                                    class="text-[10px] uppercase font-semibold text-black/40 dark:text-white/40 block">Total
                                    Nilai</span>
                                <span class="tabular-nums font-semibold text-[#34C759] dark:text-[#30D158]">
                                    Rp {{ number_format($valuation, 0, ',', '.') }}
                                </span>
                            </div>
                        </div>
                        ...
                        @if (\App\Support\Context::hasPermission('inventory.manage'))
                            ...
                            last_cost: '{{ $stock->last_cost }}'
                                    ...
                                    class="h-8 px-3.5 rounded-[8px] text-[12px] font-semibold text-[#007AFF] bg-[#007AFF]/10 hover:bg-[#007AFF]/15 active:scale-[0.97] transition-all inline-flex items-center gap-1.5">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @empty
                    <div class="py-10 px-4 text-center text-black/50 dark:text-white/50">
                        <div
                            class="w-10 h-10 rounded-full bg-black/[0.04] dark:bg-white/[0.06] flex items-center justify-center mx-auto mb-2 text-black/30 dark:text-white/30">
                        ...
                        <div class="font-semibold text-black dark:text-white text-[14px]">Belum ada stok fisik di gudang
                            ini</div>
                        <div class="text-[12px] text-black/45 dark:text-white/45 mt-1 max-w-xs mx-auto">
        ...
        @if ($receipts->isNotEmpty())
            <div
                class="rounded-[14px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 overflow-hidden shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
                <div class="px-4 py-3.5 border-b border-black/5 dark:border-white/10">
                    <h3 class="text-[15px] font-semibold text-black dark:text-white">Riwayat Penerimaan Barang (Goods
                        Receipt)</h3>
                    <p class="text-[12px] text-black/50 dark:text-white/50">Daftar inbound barang yang telah diverifikasi
                        masuk ke lokasi ini</p>
                </div>
                {{-- Desktop GR Table --}}
                <div class="hidden sm:block overflow-x-auto">
                    <table class="w-full text-left text-[13px]">
                            ...
                            @foreach ($receipts as $gr)
                                <tr class="hover:bg-black/[0.02] dark:hover:bg-white/[0.03] transition-colors">
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        @else
                                            <span class="text-black/40 dark:text-white/40 font-medium">1-Klik (Solo
                                                Mode)</span>
                                        @endif
                                    </td>
                                    <td
                                        class="px-4 py-3 text-center font-mono tabular-nums font-semibold text-black dark:text-white">
                                        {{ $gr->items->count() }}
                                    </td>
                                    <td class="px-4 py-3 text-black/60 dark:text-white/60">
                                        {{ $gr->receiver?->name ?? '-' }}
                    ...
                    @foreach ($receipts as $gr)
                        <div class="p-3.5 space-y-2 active:bg-black/[0.02] dark:active:bg-white/[0.03] transition-colors">
                            <div class="flex items-start justify-between gap-2">
                                <div>
                                    <span
                                        class="font-mono tabular-nums font-semibold text-[13px] text-black dark:text-white">#{{ $gr->receipt_number }}</span>
                                    <div class="font-medium text-[13px] text-black/80 dark:text-white/80 mt-0.5">
                                        {{ $gr->supplier?->name ?? 'Tanpa Supplier' }}</div>
                                </div>
                                <span
                                    class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-[#34C759]/12 text-[#248A3D] dark:text-[#30D158] shrink-0">
                                    <span class="w-1.5 h-1.5 rounded-full bg-[#34C759]"></span> Diterima
                                </span>
                            </div>
                            <div
                                class="grid grid-cols-2 gap-2 text-[12px] bg-black/[0.02] dark:bg-white/[0.02] p-2 rounded-[8px]">
                                <div>
                                    <span
                                        class="text-[10px] uppercase font-semibold text-black/40 dark:text-white/40 block">Tgl.
                                        Terima</span>
                                    <span
                                        class="text-black/70 dark:text-white/70">{{ $gr->receipt_date?->format('d/m/Y') ?? '-' }}</span>
                                </div>
                                <div>
                                    <span
                                        class="text-[10px] uppercase font-semibold text-black/40 dark:text-white/40 block">No.
                                        PO</span>
                                    @if ($gr->purchaseOrder)
                                        <a href="{{ route('purchase-orders.show', $gr->purchaseOrder->id) }}"
                                            class="font-mono tabular-nums text-[#007AFF] font-medium">
                                            {{ $gr->purchaseOrder->po_number }}
                                        </a>
                                    @else
                                        <span class="text-black/40 dark:text-white/40">1-Klik</span>
                                    @endif
                                </div>
                                <div>
                                    <span
                                        class="text-[10px] uppercase font-semibold text-black/40 dark:text-white/40 block">Jumlah
                                        Item</span>
                                    <span
                                        class="tabular-nums font-semibold text-black dark:text-white">{{ $gr->items->count() }}
                                        item</span>
                                </div>
                                <div>
                                    <span
                                        class="text-[10px] uppercase font-semibold text-black/40 dark:text-white/40 block">Penerima</span>
                                    <span
                                        class="text-black/70 dark:text-white/70 truncate block">{{ $gr->receiver?->name ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    @endforeach
        ...
        @if ($recentMovements->isNotEmpty())
            <div
                class="rounded-[14px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 overflow-hidden shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
                <div
                    class="px-4 py-3.5 border-b border-black/5 dark:border-white/10 flex items-center justify-between gap-3">
                    <div>
                        <h3 class="text-[15px] font-semibold text-black dark:text-white">Kartu Stok - Mutasi Terkini</h3>
                        <p class="text-[12px] text-black/50 dark:text-white/50">Audit trail pergerakan saldo barang di
                            lokasi ini</p>
                    </div>
                    <a href="{{ route('inventory.movements') }}?location_id={{ $location->id }}"
                            ...
                            @foreach ($recentMovements as $mv)
                                @php
                                    $mvLabels = [
                                        'goods_receipt' => [
                                            'label' => 'Penerimaan PO',
                                            'pill' => 'bg-[#34C759]/12 text-[#248A3D] dark:text-[#30D158]',
                                        ],
                                        'pos_sale' => [
                                            'label' => 'Penjualan POS',
                                            'pill' => 'bg-[#007AFF]/12 text-[#007AFF]',
                                        ],
                                        'adjustment' => [
                                            'label' => 'Penyesuaian Manual',
                                            'pill' => 'bg-[#FF9500]/12 text-[#B25E00] dark:text-[#FF9F0A]',
                                        ],
                                        'transfer_in' => [
                                            'label' => 'Transfer Masuk',
                                            'pill' => 'bg-[#5856D6]/12 text-[#413FA6] dark:text-[#5E5CE6]',
                                        ],
                                        'transfer_out' => [
                                        ...
                                        'opname' => [
                                            'label' => 'Rekonsiliasi Opname',
                                            'pill' => 'bg-[#AF52DE]/12 text-[#7C3AA6] dark:text-[#BF5AF2]',
                                        ],
                                        'initial' => [
                                            'label' => 'Stok Awal',
                                            'pill' => 'bg-[#007AFF]/12 text-[#007AFF]',
                                        ...
                                        'pos_refund' => [
                                            'label' => 'Refund POS',
                                            'pill' => 'bg-[#FF3B30]/12 text-[#C41E17] dark:text-[#FF453A]',
                                        ],
                                    ];
                                    $mvInfo = $mvLabels[$mv->movement_type] ?? [
                                        'label' => ucfirst(str_replace('_', ' ', $mv->movement_type)),
                                        'pill' =>
                                            'bg-black/[0.06] dark:bg-white/[0.08] text-black/60 dark:text-white/60',
                                    ];
                                @endphp
                                <tr class="hover:bg-black/[0.02] dark:hover:bg-white/[0.03] transition-colors">
                                    <td class="px-4 py-3">
                                        ...
                                        @if ($mv->product?->code)
                                            <div
                                                class="text-[11px] font-mono tabular-nums text-black/45 dark:text-white/45">
                                                {{ $mv->product->code }}</div>
                                        @endif
                                    </td>
                                    <td class="px-4 py-3">
                                        <span
                                            class="inline-flex items-center px-2 py-0.5 rounded-full text-[11px] font-semibold {{ $mvInfo['pill'] }}">
                                            {{ $mvInfo['label'] }}
                                        </span>
                                    </td>
                                    <td
                                        class="px-4 py-3 font-mono tabular-nums text-black/50 dark:text-white/50 text-[12px]">
                                        {{ $mv->reference_number ?? '-' }}
                                    </td>
                                    <td
                                        class="px-4 py-3 text-right font-mono tabular-nums font-semibold {{ $mv->quantity_change >= 0 ? 'text-[#34C759] dark:text-[#30D158]' : 'text-[#FF3B30] dark:text-[#FF453A]' }}">
                                        {{ $mv->quantity_change >= 0 ? '+' : '' }}{{ number_format($mv->quantity_change, 2) }}
                                        <span
                                            class="text-[11px] text-black/40 dark:text-white/40 font-normal ml-0.5">{{ $mv->product?->outputUnit?->symbol }}</span>
                                    </td>
                                    <td
                                        class="px-4 py-3 text-right font-mono tabular-nums font-semibold text-black dark:text-white">
                                        {{ number_format($mv->balance_after, 2) }}
                                    </td>
                                    <td class="px-4 py-3 text-black/60 dark:text-white/60">
                                        {{ $mv->creator?->name ?? 'Sistem' }}</td>
                                    <td
                                        class="px-4 py-3 text-right text-[12px] text-black/45 dark:text-white/45 whitespace-nowrap">
                                        {{ $mv->created_at->format('d/m/Y H:i') }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                    ...
                    @foreach ($recentMovements as $mv)
                        @php
                            $mvLabels = [
                                ...
                                'transfer_out' => [
                                    'label' => 'Transfer Keluar',
                                    'pill' => 'bg-black/[0.06] dark:bg-white/[0.08] text-black/60 dark:text-white/60',
                                ],
                                'opname' => [
                                    'label' => 'Rekonsiliasi Opname',
                                    'pill' => 'bg-[#AF52DE]/12 text-[#7C3AA6] dark:text-[#BF5AF2]',
                        ...
                        <div class="p-3.5 space-y-2 active:bg-black/[0.02] dark:active:bg-white/[0.03] transition-colors">
                            <div class="flex items-start justify-between gap-2">
                                <div>
                                    <div class="font-semibold text-[13px] text-black dark:text-white">
                                        {{ $mv->product?->name ?? '-' }}</div>
                                    @if ($mv->product?->code)
                                        <span
                                            class="text-[11px] font-mono tabular-nums text-black/45 dark:text-white/45">{{ $mv->product->code }}</span>
                                    @endif
                                </div>
                                <span
                                    class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold {{ $mvInfo['pill'] }} shrink-0">
                                    {{ $mvInfo['label'] }}
                                </span>
                            </div>
                            ...
                            <div
                                ...
                                <div>
                                    <span
                                        class="text-[10px] uppercase font-semibold text-black/40 dark:text-white/40 block">Perubahan
                                        Qty</span>
                                    <span
                                        class="tabular-nums font-bold {{ $mv->quantity_change >= 0 ? 'text-[#34C759] dark:text-[#30D158]' : 'text-[#FF3B30] dark:text-[#FF453A]' }}">
                                        {{ $mv->quantity_change >= 0 ? '+' : '' }}{{ number_format($mv->quantity_change, 2) }}
                                        {{ $mv->product?->outputUnit?->symbol }}
                                    </span>
                                </div>
                                <div>
                                    <span
                                        class="text-[10px] uppercase font-semibold text-black/40 dark:text-white/40 block">Saldo
                                        Akhir</span>
                                ...
                                <div>
                                    <span
                                        ...
                                        Ref</span>
                                    <span
                                        class="font-mono text-[11px] text-black/60 dark:text-white/60 truncate block">{{ $mv->reference_number ?? '-' }}</span>
                                </div>
                                <div>
                                    <span
                                        class="text-[10px] uppercase font-semibold text-black/40 dark:text-white/40 block">Waktu</span>
                                    <span
                                        class="text-[11px] text-black/50 dark:text-white/50">{{ $mv->created_at->format('d/m/y H:i') }}</span>
                                </div>
                            </div>
                        </div>
                    @endforeach
        ...
        <div x-show="showEditModal" x-cloak
            ...
            <div class="w-full max-w-lg rounded-[18px] bg-white/95 dark:bg-[#2C2C2E]/95 backdrop-blur-xl border border-black/5 dark:border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.25)] p-6 space-y-5 max-h-[90vh] overflow-y-auto"
                ...
                <div class="flex items-center justify-between border-b border-black/5 dark:border-white/10 pb-3.5">
                    <div>
                        <h3 class="text-[17px] font-semibold text-black dark:text-white">Edit Gudang:
                            {{ $location->name }}</h3>
                        <p class="text-[13px] text-black/50 dark:text-white/50">Perbarui informasi dan status operasional
                            lokasi</p>
                    </div>
                    <button type="button" @click="showEditModal = false"
                        class="p-1 rounded-[6px] text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white transition">
                ...
                <div class="w-full max-w-md rounded-[18px] bg-white/95 dark:bg-[#2C2C2E]/95 backdrop-blur-xl border border-black/5 dark:border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.25)] p-6 space-y-4"
                    ...
                    <div class="flex items-center justify-between border-b border-black/5 dark:border-white/10 pb-3">
                        <div>
                            ...
                            <p class="text-[13px] text-black/50 dark:text-white/50"
                                x-text="selectedStock ? selectedStock.product_name : ''"></p>
                        </div>
                    ...
                    <form action="{{ route('inventory.stocks.adjust') }}" method="POST"
                        class="space-y-3.5 text-[13px]">
                        @csrf
                        ...
                        <div>
                            ...
                            <div
                                class="h-10 px-3.5 rounded-[10px] bg-black/[0.04] dark:bg-white/[0.06] text-black dark:text-white font-mono tabular-nums font-semibold text-[14px] flex items-center justify-between">
                        ...
                        <div>
                            ...
                            <input type="number" name="new_quantity" step="any" x-model="newQuantity"
                                min="0" required
