    ...
    <div class="max-w-[1360px] mx-auto space-y-6 pb-12" x-data="blastForm()">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <div class="lg:col-span-7 space-y-5">
                <form action="{{ route('whatsapp.broadcast.store') }}" method="POST" id="blastForm"
                    @submit.prevent="submitBlast" class="space-y-5">
                    @csrf
                ...
                <div class="lg:sticky lg:top-24 space-y-3">
                    ...
                    <div class="relative mx-auto max-w-[300px] rounded-[36px] bg-[#1C1C1E] border-[5px] border-black/80 dark:border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.3)] overflow-hidden"
                        ...
                        <div class="bg-[#075E54] px-4 pt-8 pb-3 flex items-center gap-2.5 shadow-sm text-white">
                            <div
                                class="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center text-white shrink-0">
                        ...
                        <div class="bg-[#ECE5DD] dark:bg-[#0b141a] h-full overflow-y-auto px-3 pt-3 pb-24">
                            <div class="flex justify-end mb-2">
                                <div
                                    class="max-w-[88%] rounded-[14px] rounded-tr-[4px] bg-[#DCF8C6] dark:bg-[#005c4b] px-3.5 py-2.5 shadow-sm text-black dark:text-white">
                                    <!-- Media Preview -->
                                    <div x-show="mediaUrl" class="mb-2 rounded-[8px] overflow-hidden bg-black/10">
                                        <img :src="mediaUrl" alt="banner"
                                            class="w-full max-h-36 object-cover rounded-[8px]"
