            ...
            <div class="lg:col-span-7 space-y-6">
                ...
                <section aria-labelledby="nominal-transfer-heading"
                    ...
                    <div class="flex items-center justify-between border-b border-black/[0.06] dark:border-white/[0.08] pb-4">
                        <div>
                            <span
                                class="text-[10px] font-mono uppercase tracking-widest text-gray-500 dark:text-gray-400 font-semibold block mb-1">Total
                                Pembayaran Transfer</span>
                            <h3 id="nominal-transfer-heading" class="text-xs text-gray-600 dark:text-gray-300">Wajib
                    ...
                    <div class="py-5 flex flex-col sm:flex-row sm:items-baseline justify-between gap-4">
                        <div>
                            ...
                            <div class="text-xs text-gray-500 dark:text-gray-400 mt-1 flex items-center gap-1.5">
                                <i data-lucide="clock" class="w-3.5 h-3.5 text-[#FF9500]"
                                    aria-hidden="true"></i>
                ...
                <section aria-labelledby="destination-account-heading"
                    ...
                    <div class="space-y-2">
                        <label class="block text-xs font-semibold text-gray-700 dark:text-gray-300">Nomor Rekening Tujuan:</label>
                        <div
