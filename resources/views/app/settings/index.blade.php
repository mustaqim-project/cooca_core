...
@section('content')
    <div class="max-w-[1360px] mx-auto space-y-6 pb-16" x-data="settingsPage()">
        ...
        <!-- ===================================================== -->
        <header
            class="rounded-[14px] backdrop-blur-md bg-white/75 dark:bg-[#1C1C1E]/75 border border-black/5 dark:border-white/10 px-4 sm:px-6 py-3.5 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 shadow-sm">
            <div>
                ...
                <h1 class="text-[20px] font-semibold text-black dark:text-white tracking-tight">Pengaturan Bisnis &amp;
                    Industri</h1>
                <p class="text-[13px] text-black/50 dark:text-white/50">Profil usaha resmi, format faktur, konfigurasi kasir
                    POS, template WhatsApp, dan preset industri.</p>
            </div>

            <!-- Apple-Style Segmented Controls Switcher -->
            <div
                class="inline-flex p-0.5 rounded-[9px] bg-black/[0.06] dark:bg-white/[0.08] text-[13px] font-medium self-stretch sm:self-auto overflow-x-auto no-scrollbar max-w-full">
                <button type="button" @click="activeTab = 'general'"
                    ...
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.75a1.5 1.5 0 011.5-1.5h3a1.5 1.5 0 011.5 1.5V21" />
                    </svg>
                ...
                <button type="button" @click="activeTab = 'modules'"
                    ...
                    <span
                        class="px-1.5 py-0.5 rounded-full text-[10px] font-semibold bg-[#007AFF]/10 text-[#007AFF] tabular-nums">
        ...
        @if (session('success'))
            <div
                class="rounded-[14px] bg-[#34C759]/12 border border-[#34C759]/20 px-4 py-3 text-[13px] text-[#248A3D] dark:text-[#30D158] flex items-center gap-3">
        ...
        @if (session('error'))
            <div
                class="rounded-[14px] bg-[#FF3B30]/12 border border-[#FF3B30]/20 px-4 py-3 text-[13px] text-[#C41E17] dark:text-[#FF453A] flex items-center gap-3">
        ...
        @if ($errors->any())
            <div
                class="rounded-[14px] bg-[#FF3B30]/12 border border-[#FF3B30]/20 px-4 py-3 text-[13px] text-[#C41E17] dark:text-[#FF453A] space-y-1">
            ...
            <form method="POST" action="{{ route('settings.update') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div
                    ...
                    <div class="flex items-start justify-between gap-4 border-b border-black/5 dark:border-white/5 pb-4">
                        <div>
                            <h2 class="text-[17px] font-semibold text-black dark:text-white">Identitas Perusahaan &amp; Logo
                                Resmi</h2>
                            <p class="text-[13px] text-black/50 dark:text-white/50 mt-0.5">Informasi ini otomatis tampil
                                sebagai kop surat resmi dan instruksi pembayaran pada Faktur Penjualan (Invoice) dan
                                Purchase Order (PO).</p>
                        </div>
                        <span
                    ...
                    <div
                        ...
                        <div class="flex-1 space-y-2 text-left w-full">
                            <label for="biz_logo_input"
                                class="block text-[13px] font-semibold text-black dark:text-white">Unggah Berkas Logo
                                Baru</label>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="mt-1 text-[11px] text-black/40 dark:text-white/40">Nama usaha harus unik dan menjadi
                                bagian dari URL website publik.</p>
                        </div>
                        <div>
                ...
                <div
                    ...
                    <div class="border-b border-black/5 dark:border-white/5 pb-3">
                        <h2 class="text-[17px] font-semibold text-black dark:text-white">Konfigurasi Kasir (Point of Sale)
                        </h2>
                        <p class="text-[13px] text-black/50 dark:text-white/50 mt-0.5">Atur pemungutan pajak penjualan
                            serta tampilan kartu menu pada terminal kasir POS.</p>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 gap-3">
                            <div>
                                <p class="text-[15px] font-medium text-black dark:text-white">Pajak Penjualan (PPN / PB1)
                                </p>
                                <p class="text-[13px] text-black/50 dark:text-white/50">Aktifkan pemungutan tarif pajak
                                    otomatis pada transaksi kasir POS</p>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-4">
                            <div>
                                <p class="text-[15px] font-medium text-black dark:text-white">Foto Produk pada Menu Kasir
                                </p>
                                <p class="text-[13px] text-black/50 dark:text-white/50">Tampilkan visual foto/thumbnail
                                    produk pada kartu katalog POS</p>
                            </div>
                ...
                <div
                    class="rounded-[14px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 p-5 sm:p-6 space-y-4 shadow-sm">
                    <div class="border-b border-black/5 dark:border-white/5 pb-3">
                        <h2 class="text-[17px] font-semibold text-black dark:text-white">Instruksi Transfer Faktur
                            (Rekening Bank)</h2>
                        <p class="text-[13px] text-black/50 dark:text-white/50 mt-0.5">Rincian rekening ini otomatis
                            tercetak pada bagian bawah Faktur Penjualan resmi untuk transfer pembayaran pelanggan.</p>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            <label for="bank_name_input"
                                class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">Nama
                                Bank</label>
                        ...
                        <div>
                            <label for="bank_acc_num_input"
                                class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">Nomor
                                Rekening</label>
                        ...
                        <div>
                            <label for="bank_holder_input"
                                class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">Atas Nama
                ...
                <div
                    class="rounded-[14px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 p-5 sm:p-6 space-y-4 shadow-sm">
                    <div class="border-b border-black/5 dark:border-white/5 pb-3">
                        <h2 class="text-[17px] font-semibold text-black dark:text-white">Mata Uang &amp; Strategi
                            Pembulatan Harga</h2>
                        <p class="text-[13px] text-black/50 dark:text-white/50 mt-0.5">Strategi pembulatan diterapkan pada
                            HPP per unit final dan Harga Jual akhir produk. Kalkulasi internal tetap mempertahankan presisi
                            desimal floating-point murni.</p>
                    </div>

                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label for="currency_code_input"
                                class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">Kode Mata
                                Uang</label>
                        ...
                        <div>
                            <label for="currency_symbol_input"
                                class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">Simbol Mata
                                Uang</label>
                    ...
                    <div class="space-y-2 pt-2">
                        <label for="rounding_strategy_select"
                            class="block text-[13px] font-medium text-black/70 dark:text-white/70">Aturan Pembulatan Output
                            Akhir</label>
                        ...
                        <div
                            ...
                            <span>Simulasi Hasil: <strong class="tabular-nums font-semibold"
                                    x-text="getRoundingExample(roundingStrategy)"></strong></span>
                        </div>
                    </div>
                </div>

                <!-- Section 5: Keamanan Kasir & PIN Otorisasi Supervisor -->
                <div
                    class="rounded-[14px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 p-5 sm:p-6 space-y-5 shadow-sm">
                    <div class="flex items-start justify-between gap-4 border-b border-black/5 dark:border-white/5 pb-4">
                        <div>
                            <div class="flex items-center gap-2">
                                <h2 class="text-[17px] font-semibold text-black dark:text-white">Keamanan Kasir &amp; PIN
                                    Otorisasi Supervisor</h2>
                            ...
                            <p class="text-[13px] text-black/50 dark:text-white/50 mt-0.5">Kontrol otorisasi kasir untuk
                                tindakan berisiko seperti pemberian diskon besar, pembatalan transaksi (void), dan retur
                                produk (refund).</p>
                        </div>
                        <span
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            <label for="pos_supervisor_pin_input"
                                class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">
                                Ganti PIN Supervisor
                            </label>
                            <input type="password" id="pos_supervisor_pin_input" name="pos_supervisor_pin"
                                inputmode="numeric" maxlength="8"
                                placeholder="{{ !empty($business->pos_supervisor_pin) ? '•••••• (Biarkan kosong jika tidak diubah)' : 'Masukkan 4-8 digit angka...' }}"
                                class="w-full h-11 bg-black/[0.04] dark:bg-white/[0.06] border-none rounded-[10px] px-3.5 text-[15px] font-mono tracking-widest text-black dark:text-white placeholder:font-sans placeholder:tracking-normal placeholder:text-black/35 dark:placeholder:text-white/35 focus:outline-none focus:ring-2 focus:ring-[#007AFF]/50 transition">
                            <p class="mt-1 text-[11px] text-black/40 dark:text-white/40">Gunakan 4–8 angka rahasia. Jangan
                                bagikan kepada kasir umum.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" step="0.5" min="0" max="100"
                                    ...
                                    class="w-full h-11 bg-black/[0.04] dark:bg-white/[0.06] border-none rounded-[10px] pl-3.5 pr-8 text-[15px] tabular-nums text-black dark:text-white placeholder:text-black/35 dark:placeholder:text-white/35 focus:outline-none focus:ring-2 focus:ring-[#007AFF]/50 transition">
                                <span
                                    class="absolute right-3.5 top-1/2 -translate-y-1/2 text-[13px] font-semibold text-black/40 dark:text-white/40">%</span>
                            </div>
                            <p class="mt-1 text-[11px] text-black/40 dark:text-white/40">Diskon kasir melebihi persentase
                                ini wajib otorisasi PIN. Kosongkan jika tanpa batas.</p>
                        </div>
                    </div>
                    ...
                    <div class="pt-2 border-t border-black/5 dark:border-white/5 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <label
                            class="flex items-start gap-3 p-3 rounded-[12px] bg-black/[0.02] dark:bg-white/[0.03] border border-black/5 dark:border-white/5 cursor-pointer hover:bg-black/[0.04] dark:hover:bg-white/[0.05] transition">
                            ...
                            <div class="text-[13px]">
                                <span class="font-medium text-black dark:text-white block">Wajibkan PIN untuk Void
                                    (Pembatalan)</span>
                                <span class="text-[11px] text-black/50 dark:text-white/50 block mt-0.5">Kasir wajib meminta
                                    PIN Supervisor saat membatalkan transaksi pada riwayat POS.</span>
                            </div>
                        </label>
                        ...
                        <label
                            ...
                            <input type="checkbox" name="pos_require_pin_for_refund" value="1"
                                ...
                                class="mt-0.5 rounded-[4px] border-black/20 text-[#007AFF] focus:ring-[#007AFF]">
                            <div class="text-[13px]">
                                <span class="font-medium text-black dark:text-white block">Wajibkan PIN untuk Retur
                                    (Refund)</span>
                                <span class="text-[11px] text-black/50 dark:text-white/50 block mt-0.5">Mencegah
                                    pengembalian dana atau retur barang tanpa persetujuan supervisor.</span>
                            </div>
                        </label>
                    </div>
                </div>
        ...
        <div x-show="activeTab === 'wa_receipt'" class="space-y-6" style="display: none;">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
                ...
                <div class="lg:col-span-7 space-y-6">
                    <div
                        class="rounded-[16px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 p-5 sm:p-6 space-y-5 shadow-sm">
                        <div class="border-b border-black/5 dark:border-white/5 pb-4">
                            <div class="flex items-center gap-3">
                                <div
                                    class="w-9 h-9 rounded-[10px] bg-[#34C759]/12 text-[#34C759] flex items-center justify-center shrink-0">
                                ...
                                <div>
                                    <h2 class="text-[17px] font-semibold text-black dark:text-white">Kustomisasi Pesan
                                        WhatsApp Struk</h2>
                                    <p class="text-[13px] text-black/50 dark:text-white/50 mt-0.5">Atur format teks pesan
                                        yang menyertai gambar struk saat kasir mengirim ke nomor WhatsApp pelanggan.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <form method="POST" action="{{ route('settings.update') }}" class="space-y-5">
                            ...
                            <div class="space-y-2">
                                <label class="block text-[13px] font-medium text-black/80 dark:text-white/80">
                                    Variabel Dinamis <span
                                        class="text-[11px] font-normal text-black/40 dark:text-white/40">(Klik untuk
                                        menyisipkan ke kursor teks)</span>
                                </label>
                            ...
                            <div class="space-y-2">
                                <div class="flex items-center justify-between">
                                    <label for="pos_receipt_wa_template"
                                        class="block text-[13px] font-medium text-black/80 dark:text-white/80">
                                ...
                                <p class="text-[11px] text-black/45 dark:text-white/45">
                                    Catatan: Detail rincian pesanan, total belanja, dan QR sudah otomatis tercetak rapi di
                                    dalam <strong>gambar file struk PNG</strong>.
                                </p>
                            </div>

                            <!-- Catatan Kaki Tambahan (pos_receipt_footer_note) -->
                            <div class="space-y-1.5 pt-1">
                                <label for="pos_receipt_footer_note"
                                    class="block text-[13px] font-medium text-black/80 dark:text-white/80">
                                    Catatan Kaki Struk <span
                                        class="text-[11px] font-normal text-black/40 dark:text-white/40">({footer_note})</span>
                                </label>
                            ...
                            <div
                                class="rounded-[10px] bg-black/[0.02] dark:bg-white/[0.03] border border-black/5 dark:border-white/5 p-3.5 text-[12px] space-y-1.5">
                ...
                <div class="lg:col-span-5">
                    <div class="lg:sticky lg:top-6 space-y-3">
                        <div class="flex items-center justify-between px-1">
                            <span
                                class="text-[12px] font-semibold tracking-wider uppercase text-black/40 dark:text-white/40">Pratinjau
                                Langsung (Live Preview)</span>
                        ...
                        <div
                            class="w-full max-w-[340px] mx-auto rounded-[38px] p-2.5 bg-neutral-900 shadow-[0_20px_60px_rgba(0,0,0,0.35)] border border-neutral-800">
                            <div
                                class="rounded-[28px] overflow-hidden bg-[#EFEAE2] dark:bg-[#0B141A] flex flex-col min-h-[510px] border border-black/10 dark:border-white/10 select-none relative">
                                ...
                                <!-- WhatsApp Top Bar -->
                                <div
                                    class="bg-[#075E54] dark:bg-[#1F2C34] text-white px-3.5 py-2.5 flex items-center gap-2.5 shadow-sm">
                                    <div
                                        class="w-8 h-8 rounded-full bg-white/20 text-white font-bold text-[13px] flex items-center justify-center">
                                        {{ strtoupper(substr($business->name ?? 'T', 0, 1)) }}
                                    </div>
                                    <div class="flex-1 min-w-0">
                                        <h4 class="text-[13px] font-semibold truncate leading-tight text-white">
                                            {{ $business->name ?? 'Toko Saya' }}</h4>
                                ...
                                <div class="flex-1 p-3 flex flex-col justify-end space-y-2 overflow-y-auto">
                                    ...
                                    <div
                                        class="bg-[#D9FDD3] dark:bg-[#005C4B] text-[#111B21] dark:text-[#E9EDEF] rounded-[12px] rounded-tr-none p-2 shadow-sm max-w-[95%] ml-auto text-[12.5px] leading-relaxed space-y-2">

                                        <!-- Simulated Receipt Image Thumbnail -->
                                        <div
                                            class="rounded-[8px] overflow-hidden bg-white dark:bg-[#111B21] border border-black/5 dark:border-white/10 p-3 shadow-sm text-center space-y-1.5">
                                            <div
                                                class="flex items-center justify-center gap-1 text-[11px] font-semibold text-black/70 dark:text-white/70">
                                                <span>🧾</span>
                                                <span>STRUK DIGITAL</span>
                                            </div>
                                            <div
                                                class="h-[1px] w-full border-t border-dashed border-black/20 dark:border-white/20">
                                            </div>
                                            <div class="text-[11px] font-bold text-black/80 dark:text-white/80">
                                                {{ $business->name ?? 'Toko Saya' }}</div>
                                            <div
                                                class="text-[9.5px] text-black/50 dark:text-white/50 font-mono tabular-nums">
                                                No: POS-20260910-0042</div>
                                            <div class="py-1">
                                                <span
                                                    class="inline-block px-2 py-0.5 rounded bg-black/5 dark:bg-white/10 text-[10px] font-semibold text-black/70 dark:text-white/70">
                                            ...
                                            <div
                                                class="text-[9.5px] text-[#248A3D] dark:text-[#30D158] font-semibold tabular-nums">
                                                LUNAS • Rp 85.000</div>
                                        </div>
                                        ...
                                        <!-- Time & Read Status -->
                                        <div
                                            class="flex items-center justify-end gap-1 text-[10px] text-black/45 dark:text-white/50 select-none">
                                ...
                                <div
                                    class="bg-[#F0F2F5] dark:bg-[#1F2C34] p-2 flex items-center gap-2 border-t border-black/5 dark:border-white/5">
                                    <div
                                        class="w-6 h-6 rounded-full bg-black/10 dark:bg-white/10 flex items-center justify-center text-black/50 dark:text-white/50 text-[11px] font-bold">
                                        +</div>
                                    <div
                                        class="flex-1 h-7 rounded-full bg-white dark:bg-[#2A3942] px-3 flex items-center text-[11px] text-black/40 dark:text-white/40">
                                        Ketik pesan</div>
                                    <div
                                        class="w-6 h-6 rounded-full bg-[#00A884] text-white flex items-center justify-center text-[11px]">
                                        ▶</div>
                                </div>
                        ...
                        <div
                            class="rounded-[12px] bg-[#007AFF]/8 border border-[#007AFF]/15 p-3 text-[12px] text-black/60 dark:text-white/60 space-y-1">
                            <p class="font-medium text-[#007AFF] flex items-center gap-1.5">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M12 18v-5.25m0 0a6.002 6.002 0 00-4-5.659V5a2 2 0 114 0v2.091a6.002 6.002 0 004 5.659V18m-4 0v1.5a1.5 1.5 0 01-3 0V18m3 0h-3" />
                                </svg>
                                <span>Informasi Pengiriman</span>
                            </p>
                            <p>Format pesan di atas dikirim otomatis sebagai <strong>caption gambar struk</strong> ketika
                                kasir menekan tombol kirim WhatsApp di POS atau melalui WhatsApp Gateway bot.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p class="text-[13px] text-black/50 dark:text-white/50 mt-0.5">Terapkan struktur kategori dan
                            komponen biaya default secara instan tanpa mengunci kebebasan kustomisasi mandiri Anda.</p>
                    </div>
        ...
        @if (\App\Support\Context::hasPermission('settings.edit'))
            <div x-show="templateModalOpen" x-cloak
                ...
                <div class="w-[310px] rounded-[14px] bg-white/95 dark:bg-[#2C2C2E]/95 backdrop-blur-xl overflow-hidden text-center shadow-[0_20px_50px_rgba(0,0,0,0.25)] border border-black/5 dark:border-white/10"
                    @click.away="closeApplyTemplate()" x-transition:enter="transition ease-out duration-200"
                    ...
                    <div class="px-5 pt-5 pb-4">
                        ...
                        <p class="text-[13px] text-black/60 dark:text-white/60 mt-1.5 leading-snug">
                            Terapkan preset <strong class="text-black dark:text-white"
                                x-text="selectedTemplate.name"></strong> ke bisnis Anda? Kategori dan akun biaya default
                            akan ditambahkan.
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-2 border-t border-black/10 dark:border-white/10 text-[15px] font-medium">
                        ...
                        <button type="button" @click="submitApplyTemplate()"
                            class="py-3 text-[#007AFF] font-semibold active:bg-black/5 dark:active:bg-white/5 transition-colors">
                            Terapkan
                        </button>
                    </div>
                </div>
    ...
    <script>
        function settingsPage() {
            return {
                ...
                waTemplateText: @json(
                    $business->pos_receipt_wa_template ?:
