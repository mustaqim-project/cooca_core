    ...
    <div class="max-w-[1360px] mx-auto space-y-6 pb-12" x-data="{
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            ...
            <div
                ...
                <div class="mt-2 flex items-baseline justify-between">
                    <span
                        class="text-[24px] font-bold tabular-nums text-[#34C759] dark:text-[#30D158]">{{ $members->count() }}</span>
            ...
            <div
                ...
                <div class="mt-2 flex items-baseline justify-between">
                    <span
                        class="text-[24px] font-bold tabular-nums text-[#5856D6] dark:text-[#5E5CE6]">{{ collect($permissions)->flatten(1)->count() }}</span>
        ...
        <div x-show="showGuide" x-transition
            class="rounded-[14px] bg-black/[0.02] dark:bg-white/[0.03] border border-black/5 dark:border-white/5 p-4 sm:p-5 space-y-3">
            <div class="flex items-center gap-2">
                <span class="w-2 h-2 rounded-full bg-[#007AFF]"></span>
                <h2 class="text-[13px] font-semibold uppercase tracking-wider text-black/60 dark:text-white/60">Prinsip
                    Keamanan Role &amp; Hak Akses (RBAC)</h2>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
                <div
                    class="rounded-[10px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 p-3 space-y-1">
                    <span class="text-[11px] font-semibold text-[#007AFF]">1. Hak Istimewa Owner</span>
                    <p class="text-[12px] text-black/60 dark:text-white/60 leading-relaxed">Pemilik usaha (Owner) memiliki
                        wewenang penuh tanpa batas ke seluruh modul dan keuangan.</p>
                </div>
                <div
                    class="rounded-[10px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 p-3 space-y-1">
                    <span class="text-[11px] font-semibold text-[#34C759]">2. Preset vs Custom</span>
                    <p class="text-[12px] text-black/60 dark:text-white/60 leading-relaxed">Gunakan preset default (Kasir,
                        Staff Gudang) atau susun role custom sesuai kebutuhan toko.</p>
                </div>
                <div
                    class="rounded-[10px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 p-3 space-y-1">
                    <span class="text-[11px] font-semibold text-[#FF9500]">3. Tautkan Akun Karyawan</span>
                    <p class="text-[12px] text-black/60 dark:text-white/60 leading-relaxed">Tambahkan akun login staf di tab
                        <em>Anggota Tim</em>. Role dapat diubah seketika kapan saja.</p>
                </div>
                <div
                    class="rounded-[10px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 p-3 space-y-1">
                    <span class="text-[11px] font-semibold text-[#AF52DE]">4. Proteksi Margin &amp; HPP</span>
                    <p class="text-[12px] text-black/60 dark:text-white/60 leading-relaxed">Nonaktifkan izin
                        <code>costing.view_margin</code> pada staf agar modal resep &amp; margin tetap rahasia.</p>
                </div>
            </div>
        </div>
            ...
            <div x-show="activeTab === 'roles'" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach ($roles as $role)
                        ...
                        @endphp
                        <div
                            class="rounded-[14px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 p-5 flex flex-col justify-between gap-4">
                            <div class="space-y-3">
                                <div class="flex items-start justify-between gap-2">
                                    <div>
                                        <div class="flex items-center gap-2">
                                            ...
                                            @if ($isCustom)
                                                <span
                                                    class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-[#007AFF]/12 text-[#007AFF]">
                                                    Custom
                                                </span>
                                            @else
                                                <span
                                                    class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-black/[0.06] dark:bg-white/[0.08] text-black/60 dark:text-white/60">
                                                    Preset Sistem
                                                </span>
                                            @endif
                                        </div>
                                        <p
                                            class="text-[12px] text-black/50 dark:text-white/50 mt-1 line-clamp-2 leading-relaxed">
                                ...
                                <!-- Role Stats -->
                                <div
                                    class="flex items-center gap-4 text-[12px] text-black/50 dark:text-white/50 pt-3 border-t border-black/[0.04] dark:border-white/[0.06]">
                                    <div class="flex items-center gap-1.5">
                                        <span
                                            class="font-bold tabular-nums text-black dark:text-white">{{ $role->permissions->count() }}</span>
                                        <span>hak akses</span>
                                    </div>
                                    <div class="flex items-center gap-1.5">
                                        <span
                                            class="font-bold tabular-nums text-black dark:text-white">{{ $memberCount }}</span>
                                        <span>anggota</span>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-1.5">
                                    <span
                                        class="text-[10px] font-semibold uppercase tracking-wider text-black/40 dark:text-white/40">Cakupan
                                        Izin:</span>
                                    <div class="flex flex-wrap gap-1 max-h-24 overflow-y-auto pr-1">
                                        @forelse($role->permissions->take(8) as $perm)
                                            <span
                                                class="text-[11px] px-2 py-0.5 rounded-[6px] bg-black/[0.04] dark:bg-white/[0.06] text-black/70 dark:text-white/70 tabular-nums">
                                                {{ \Illuminate\Support\Str::after($perm->slug, '.') }}
                                            </span>
                                        @empty
                                            <span class="text-[11px] text-black/40 dark:text-white/40 italic">Belum ada hak
                                                akses yang ditugaskan.</span>
                                        @endforelse
                                        @if ($role->permissions->count() > 8)
                                            <span
                                                class="text-[11px] px-1.5 py-0.5 rounded-[6px] bg-black/[0.08] dark:bg-white/[0.1] text-black/70 dark:text-white/70 font-semibold tabular-nums">
                                ...
                                @if ($isCustom)
                                    ...
                                    @if (\App\Support\Context::hasPermission('roles.delete') || \App\Support\Context::hasPermission('roles.manage'))
                                        ...
                                        <form id="form-delete-role-{{ $role->id }}" method="POST"
                                            action="{{ route('roles.destroy', $role) }}" class="hidden">
                                            @csrf
                                            @method('DELETE')
                                        </form>
                                    @endif
            ...
            <div x-show="activeTab === 'members'" class="space-y-6" style="display: none;">
                @if (\App\Support\Context::hasPermission('users.create') || \App\Support\Context::hasPermission('users.manage'))
                    ...
                    <div
                        ...
                        <div class="border-b border-black/5 dark:border-white/5 pb-3">
                            ...
                            <p class="text-[13px] text-black/50 dark:text-white/50 mt-0.5">Buat akun login untuk kasir,
                                kepala gudang, atau staf operasional bisnis Anda.</p>
                        </div>

                        <form method="POST" action="{{ route('roles.members.store') }}"
                            class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3.5 items-end">
                            @csrf
                            <div>
                                <label class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">Nama
                                    Karyawan <span class="text-[#FF3B30]">*</span></label>
                            ...
                            <div>
                                <label class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">Email
                                    Login <span class="text-[#FF3B30]">*</span></label>
                            ...
                            <div>
                                <label
                                    class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">Password
                                    Awal</label>
                            ...
                            <div>
                                <label class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">Role /
                                    Jabatan <span class="text-[#FF3B30]">*</span></label>
                ...
                <div
                    ...
                    <div class="p-4 border-b border-black/5 dark:border-white/10 flex items-center justify-between">
                        <div>
                            <h3 class="text-[15px] font-semibold text-black dark:text-white">Daftar Pengguna Aktif di
                                {{ $business->name }}</h3>
                            <p class="text-[12px] text-black/50 dark:text-white/50">Akun dengan wewenang akses aktif ke
                                workspace bisnis ini.</p>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-[13px]">
                            <thead>
                                <tr
                                    class="border-b border-black/5 dark:border-white/10 text-black/40 dark:text-white/40 text-[11px] font-semibold uppercase tracking-wide">
                                    <th class="py-2.5 px-4">Nama Pengguna</th>
                                    <th class="py-2.5 px-4">Email Login</th>
                                    <th class="py-2.5 px-4">Role / Wewenang</th>
                                    @if (
                                        \App\Support\Context::hasPermission('users.edit') ||
                                            \App\Support\Context::hasPermission('users.delete') ||
                                            \App\Support\Context::hasPermission('users.manage'))
                            ...
                            <tbody class="divide-y divide-black/[0.04] dark:divide-white/[0.06]">
                                @foreach ($members as $member)
                                    @php
                                        $memberRoleId =
                                            $member->role_id ?? ($roles->firstWhere('slug', $member->role)?->id ?? '');
                                    @endphp
                                    <tr class="hover:bg-black/[0.02] dark:hover:bg-white/[0.03] transition-colors">
                                        <td class="py-3 px-4">
                                            <div class="flex items-center gap-3">
                                                <div
                                                    class="w-8 h-8 rounded-full bg-[#007AFF]/10 text-[#007AFF] flex items-center justify-center font-bold text-[12px] uppercase shrink-0">
                                                    {{ substr($member->user?->name ?? 'U', 0, 2) }}
                                                </div>
                                                <div>
                                                    <span
                                                        class="font-medium text-black dark:text-white">{{ $member->user?->name }}</span>
                                                    @if ($member->role === 'owner')
                                                        <span
                                                            class="ml-1.5 px-2 py-0.5 rounded-full text-[10px] font-semibold bg-[#AF52DE]/12 text-[#AF52DE]">Owner</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="py-3 px-4">
                                            <span
                                                class="inline-flex items-center px-2.5 py-1 rounded-[6px] bg-black/[0.05] dark:bg-white/[0.08] text-black/80 dark:text-white/80 font-medium text-[12px]">
                                        ...
                                        @if (
                                            ...
                                            <td class="py-3 px-4 text-right">
                                                @if ($member->role !== 'owner')
                                                    <div class="flex items-center justify-end gap-1.5">
                                                        ...
                                                        @if (\App\Support\Context::hasPermission('users.delete') || \App\Support\Context::hasPermission('users.manage'))
                                                            ...
                                                            <form id="form-delete-member-{{ $member->id }}"
                                                                method="POST"
                                                                action="{{ route('roles.members.destroy', $member->id) }}"
                                                                class="hidden">
                                                                @csrf
                                                                @method('DELETE')
                                                            </form>
                                                ...
                                                @else
                                                    <span class="text-[11px] text-black/40 dark:text-white/40 italic">Owner
                                                        Utama</span>
                                                @endif
                                            </td>
                                        @endif
        ...
        @if (\App\Support\Context::hasPermission('roles.view') || \App\Support\Context::hasPermission('roles.manage'))
            ...
            <div x-show="activeTab === 'matrix'" class="space-y-4" style="display: none;">
                <div
                    class="rounded-[14px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 p-4 sm:p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <h2 class="text-[17px] font-semibold text-black dark:text-white">Matriks Hak Akses &amp; Modul
                            Sistem</h2>
                        <p class="text-[13px] text-black/50 dark:text-white/50 mt-0.5">Daftar seluruh wewenang granular
                            sistem yang dapat dikonfigurasikan pada role custom.</p>
                    </div>
                    ...
                    <div class="relative w-full sm:w-64">
                        ...
                        <input type="text" x-model="searchPermission" placeholder="Cari izin / modul..."
                ...
                @if (($hiddenPermissionsCount ?? 0) > 0)
                    <div
                        class="rounded-[12px] bg-[#007AFF]/10 border border-[#007AFF]/20 p-3.5 flex items-start gap-3 text-[12px] text-[#007AFF] dark:text-[#64D2FF]">
                        ...
                        <div class="flex-1">
                            <span class="font-semibold">{{ $hiddenPermissionsCount }} hak akses disembunyikan
                                otomatis</span> sesuai profil industri bisnis Anda saat ini agar menu tidak menumpuk. Anda
                            dapat mengaktifkan modul kapan saja di
                            <a href="{{ route('settings.index', ['tab' => 'modules']) }}"
                                class="font-semibold underline hover:opacity-80">Pengaturan &rsaquo; Kelola Modul &amp;
                                Fitur</a>.
                        </div>
                    </div>
                @endif
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach ($permissions as $category => $categoryPermissions)
                        <div
                            class="rounded-[14px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 p-4 space-y-3">
                            <div
                                class="flex items-center justify-between pb-2 border-b border-black/5 dark:border-white/10">
                                <span
                                    class="text-[12px] font-semibold text-black dark:text-white uppercase tracking-wider">
                                    {{ $category ?: 'Modul Umum' }}
                                </span>
                                <span
                                    class="text-[11px] tabular-nums text-black/40 dark:text-white/40">{{ count($categoryPermissions) }}
                                    item</span>
                            </div>
                            ...
                            <div class="space-y-1.5">
                                @foreach ($categoryPermissions as $permission)
                                    <div class="p-2.5 rounded-[8px] bg-black/[0.02] dark:bg-white/[0.03] border border-black/[0.04] dark:border-white/[0.06] flex items-start gap-2.5"
                                        ...
                                        <div class="min-w-0">
                                            <div class="text-[13px] font-medium text-black dark:text-white">
                                                {{ $permission->name }}</div>
                                            <div class="text-[11px] font-mono text-black/40 dark:text-white/40 mt-0.5">
                                                {{ $permission->slug }}</div>
                                        </div>
                                    </div>
                                @endforeach
        ...
        @if (
            \App\Support\Context::hasPermission('roles.create') ||
                \App\Support\Context::hasPermission('roles.edit') ||
                \App\Support\Context::hasPermission('roles.manage'))
            <!-- ===================================================== -->
            ...
            <div x-show="showCreateModal" x-cloak
                ...
                <div class="bg-white/95 dark:bg-[#2C2C2E]/95 backdrop-blur-xl w-full max-w-2xl max-h-[90vh] rounded-[18px] border border-black/10 dark:border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.25)] overflow-hidden flex flex-col"
                    ...
                    <div class="px-6 py-4 border-b border-black/5 dark:border-white/10 flex items-center justify-between">
                        <div>
                            <h3 class="text-[17px] font-semibold text-black dark:text-white"
                                x-text="editingRole ? (editingPreset ? 'Edit Permission: ' + editingRole.name : 'Edit Role: ' + editingRole.name) : 'Buat Role Custom Baru'">
                            </h3>
                            <p class="text-[12px] text-black/50 dark:text-white/50"
                                x-text="editingPreset ? 'Hak akses preset role dapat diubah. Nama role sistem tidak dapat dimodifikasi.' : 'Tentukan kombinasi hak akses yang diizinkan untuk peran ini.'">
                            </p>
                        </div>
                        <button type="button" @click="showCreateModal = false"
                            class="w-8 h-8 rounded-[8px] hover:bg-black/5 dark:hover:bg-white/5 flex items-center justify-center text-black/50 dark:text-white/50 transition">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                    ...
                    <!-- Form -->
                    <form :action="editingRole ? editFormAction : '{{ route('roles.store') }}'" method="POST"
                        ...
                        <div class="p-6 space-y-5 overflow-y-auto flex-1">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="name" :required="!editingPreset"
                                        :value="editingRole ? editingRole.name : ''" :disabled="editingPreset"
                                        :class="editingPreset ? 'opacity-50 cursor-not-allowed' : ''"
                                        placeholder="Contoh: Kasir Shift Pagi"
                                        class="w-full h-11 bg-black/[0.04] dark:bg-white/[0.06] border-none rounded-[10px] px-3.5 text-[14px] text-black dark:text-white placeholder:text-black/35 dark:placeholder:text-white/35 focus:outline-none focus:ring-2 focus:ring-[#007AFF]/50 transition">
                                    <p class="text-[11px] text-[#FF9500] mt-1 flex items-center gap-1"
                                        x-show="editingPreset">
                                ...
                                <div>
                                    <label
                                        class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">Deskripsi
                                        Peran</label>
                                    <input type="text" name="description"
                                        :value="editingRole ? editingRole.description : ''" :disabled="editingPreset"
                                        :class="editingPreset ? 'opacity-50 cursor-not-allowed' : ''"
                            ...
                            <div class="space-y-3 pt-2">
                                <div class="flex items-center justify-between">
                                    <label class="text-[13px] font-semibold text-black dark:text-white">Pilih Hak Akses
                                        (Permissions) <span class="text-[#FF3B30]">*</span></label>
                                    <span class="text-[12px] font-semibold text-[#007AFF] tabular-nums"
                                        x-text="selectedPermissions.length + ' hak akses dipilih'"></span>
                                </div>

                                @if (($hiddenPermissionsCount ?? 0) > 0)
                                    <div
                                        class="rounded-[10px] bg-black/[0.03] dark:bg-white/[0.04] border border-black/5 dark:border-white/5 p-2.5 text-[11px] text-black/60 dark:text-white/60 flex items-center justify-between gap-2">
                                        <span>Modul yang dinonaktifkan untuk bisnis ini disembunyikan dari daftar
                                            izin.</span>
                                        <a href="{{ route('settings.index', ['tab' => 'modules']) }}" target="_blank"
                                            class="text-[#007AFF] hover:underline font-medium shrink-0">Buka Pengaturan
                                            Modul &rarr;</a>
                                    </div>
                                @endif
                                ...
                                <div class="space-y-3 max-h-96 overflow-y-auto pr-1">
                                    @foreach ($permissions as $category => $categoryPermissions)
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center justify-between">
                                                <span
                                                    class="text-[12px] font-semibold uppercase tracking-wide text-black/70 dark:text-white/70">
                                                    {{ $category ?: 'Lainnya' }}
                                                </span>
                                                <button type="button"
                                                    ...
                                                    <span
                                                        x-text="isCategoryAllSelected({{ Js::from($categorySlugs) }}) ? 'Batal Semua' : 'Pilih Semua'"></span>
                                                </button>
                                            </div>
                                            ...
                                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                @foreach ($categoryPermissions as $permission)
                                                    <label
                                                        class="flex items-start gap-2.5 p-2 rounded-[8px] bg-white dark:bg-[#1C1C1E] border border-black/5 dark:border-white/5 hover:border-[#007AFF]/30 cursor-pointer transition select-none">
                                                        <input type="checkbox" name="permissions[]"
                                                            value="{{ $permission->slug }}" x-model="selectedPermissions"
                                                            class="mt-0.5 rounded-[4px] border-black/20 text-[#007AFF] focus:ring-[#007AFF]">
                                                        <div class="min-w-0">
                                                            <span
                                                                class="font-medium text-black dark:text-white text-[12px] block">{{ $permission->name }}</span>
                                                            <span
                                                                class="text-[10px] font-mono text-black/40 dark:text-white/40 block truncate">{{ $permission->slug }}</span>
                                                        </div>
                                                    </label>
                                                @endforeach
                                            </div>
                        ...
                        <!-- Footer -->
                        <div
                            class="px-6 py-3.5 border-t border-black/5 dark:border-white/10 flex items-center justify-end gap-2">
                            <button type="button" @click="showCreateModal = false"
                            ...
                            <button type="submit"
                                ...
                                <span
                                    x-text="editingPreset ? 'Simpan Permission' : (editingRole ? 'Simpan Perubahan' : 'Buat Role Custom')"></span>
                            </button>
                        </div>
                    </form>
                </div>
        ...
        @if (\App\Support\Context::hasPermission('users.edit') || \App\Support\Context::hasPermission('users.manage'))
            ...
            <!-- ===================================================== -->
            <div x-show="showMemberRoleModal" x-cloak
                class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/25 backdrop-blur-[2px]"
                x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0"
                x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150"
                x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                ...
                <div class="bg-white/95 dark:bg-[#2C2C2E]/95 backdrop-blur-xl w-full max-w-md rounded-[18px] border border-black/10 dark:border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.25)] overflow-hidden flex flex-col"
                    @click.away="showMemberRoleModal = false" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
                    x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 scale-100"
                    x-transition:leave-end="opacity-0 scale-95">
                    ...
                    <div class="px-5 py-4 border-b border-black/5 dark:border-white/10 flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-[12px] text-black/50 dark:text-white/50"
                                x-text="editingMember ? (editingMember.user ? editingMember.user.name : 'Anggota') : ''">
                            </p>
                        </div>
                    ...
                    <form :action="memberRoleAction" method="POST" class="p-5 space-y-4">
                        ...
                        <div>
                            <label class="block text-[13px] font-medium text-black/70 dark:text-white/70 mb-1.5">Pilih Role
                                / Jabatan Baru <span class="text-[#FF3B30]">*</span></label>
                        ...
                        <div
                            class="rounded-[10px] bg-[#007AFF]/8 border border-[#007AFF]/15 p-3 text-[12px] text-[#007AFF] leading-relaxed">
                            Perubahan wewenang akan langsung aktif saat karyawan mengakses menu atau memproses transaksi di
                            Cooca.
                        </div>
        ...
        @if (\App\Support\Context::hasPermission('roles.delete') || \App\Support\Context::hasPermission('roles.manage'))
            ...
            <!-- ===================================================== -->
            <div x-show="deleteRoleModalOpen" x-cloak
                ...
                <div class="w-[290px] rounded-[14px] bg-white/95 dark:bg-[#2C2C2E]/95 backdrop-blur-xl overflow-hidden text-center shadow-[0_20px_50px_rgba(0,0,0,0.25)] border border-black/5 dark:border-white/10"
                    @click.away="closeDeleteRole()" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
                    x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 scale-100"
                    x-transition:leave-end="opacity-0 scale-95">
                    ...
                    <div class="px-4 pt-5 pb-4">
                        ...
                        <p class="text-[13px] text-black/60 dark:text-white/60 mt-1 leading-snug">
                            Role <span x-text="deleteRoleTarget.name"
                                class="font-medium text-black dark:text-white"></span> akan dihapus. Pastikan anggota
                            dengan role ini telah dialihkan.
                        </p>
                    </div>

                    <div class="grid grid-cols-2 border-t border-black/10 dark:border-white/10 text-[15px] font-medium">
                        <button type="button" @click="closeDeleteRole()"
                        ...
                        <button type="button" @click="submitDeleteRole()"
        ...
        @if (\App\Support\Context::hasPermission('users.delete') || \App\Support\Context::hasPermission('users.manage'))
            ...
            <!-- ===================================================== -->
            <div x-show="deleteMemberModalOpen" x-cloak
                class="fixed inset-0 z-50 flex items-center justify-center bg-black/25 backdrop-blur-[2px]"
                x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0"
                x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-150"
                x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                ...
                <div class="w-[290px] rounded-[14px] bg-white/95 dark:bg-[#2C2C2E]/95 backdrop-blur-xl overflow-hidden text-center shadow-[0_20px_50px_rgba(0,0,0,0.25)] border border-black/5 dark:border-white/10"
                    @click.away="closeDeleteMember()" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 scale-95" x-transition:enter-end="opacity-100 scale-100"
                    x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 scale-100"
                    x-transition:leave-end="opacity-0 scale-95">
                    ...
                    <div class="px-4 pt-5 pb-4">
                        ...
                        <p class="text-[13px] text-black/60 dark:text-white/60 mt-1 leading-snug">
                            Akses <span x-text="deleteMemberTarget.name"
                                class="font-medium text-black dark:text-white"></span> ke workspace bisnis ini akan
                            langsung dicabut.
                        </p>
                    </div>

                    <div class="grid grid-cols-2 border-t border-black/10 dark:border-white/10 text-[15px] font-medium">
                        <button type="button" @click="closeDeleteMember()"
                            class="py-3 text-[#007AFF] border-r border-black/10 dark:border-white/10 active:bg-black/5 dark:active:bg-white/5 transition-colors">
                            Batal
                        </button>
                        <button type="button" @click="submitDeleteMember()"
                            class="py-3 text-[#FF3B30] font-semibold active:bg-black/5 dark:active:bg-white/5 transition-colors">
                            Keluarkan
                        </button>
                    </div>
