    ...
    <div class="no-print max-w-4xl mx-auto mb-6 bg-slate-900 text-white p-4 rounded-2xl shadow-xl space-y-3">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            <div class="flex items-center gap-2">
                ...
                <span class="text-xs font-bold tracking-tight">Dokumen Faktur Penjualan (A4 Ready)</span>
            </div>
    ...
    <div
        ...
        <div class="flex justify-between items-start border-b-2 border-slate-900 pb-5">
            <div class="space-y-2 max-w-md">
                ...
                <div class="space-y-0.5">
                    ...
                    @if ($business->tax_identification_number)
                        <p class="text-xs text-slate-600 font-mono">NPWP: {{ $business->tax_identification_number }}
                        </p>
                    @endif
                </div>
            </div>
            ...
            <div class="text-right space-y-0.5">
                ...
                <div class="text-sm font-mono font-bold text-slate-800">{{ $invoice->invoice_number }}</div>
                @if ($invoice->purchaseOrder)
                    <div class="text-xs text-slate-500 font-mono">No. PO: {{ $invoice->purchaseOrder->po_number }}
                    </div>
                @endif
            ...
            <div class="grid grid-cols-2 gap-8 text-xs">
                <div class="space-y-1.5">
                    ...
                    @if ($invoice->customer?->tax_identification_number)
                        <div class="text-slate-600 font-mono">NPWP: {{ $invoice->customer->tax_identification_number }}
                        </div>
                    @endif
                </div>
                ...
                <div class="space-y-2 text-right">
                    <div class="flex justify-end gap-4">
                        ...
                        <span
                            class="font-mono font-bold text-slate-900">{{ $invoice->invoice_date?->translatedFormat('d F Y') }}</span>
                    </div>
                    <div class="flex justify-end gap-4">
                        <span class="text-slate-500">Tanggal Jatuh Tempo:</span>
                        <span
                            class="font-mono font-bold text-slate-900">{{ $invoice->due_date?->translatedFormat('d F Y') }}</span>
                    </div>
                    <div class="flex justify-end gap-4">
                ...
                <div class="flex justify-between items-start border-t-2 border-slate-900 pt-2 gap-6 text-xs">
                        ...
                        <div class="p-3 border-l-2 border-slate-400 bg-slate-50/70 space-y-1.5 text-slate-700">
                            ...
                            <div class="pt-1 space-y-1 text-xs">
                                ...
                                <div class="flex items-baseline gap-2">
                                    ...
                                    <span class="text-slate-400">:</span>
                                    <span class="font-mono font-bold text-slate-950 text-sm tracking-wider">{{ $business->bank_account_number ?? '123-456-7890' }}</span>
                                </div>
                                <div class="flex items-baseline gap-2">
                    ...
                    <div class="w-72 space-y-2">
                        ...
                        <div class="flex justify-between text-slate-600 pt-1">
                            ...
                            <span class="font-mono font-semibold text-emerald-700">{{ $business->currency_symbol }}
