...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::table('billing_packages')->insert([
            ['id' => (string) Str::uuid(), 'type' => 'subscription', 'code' => 'core-monthly', 'name' => 'Patungan Bulanan', 'description' => 'Akses penuh Cooca selama 30 hari.', 'price' => 25000, 'duration_days' => 30, 'token_quantity' => null, 'storage_bytes' => null, 'token_expiry_days' => null, 'is_active' => true, 'sort_order' => 1, 'created_at' => $now, 'updated_at' => $now],
            ['id' => (string) Str::uuid(), 'type' => 'subscription', 'code' => 'core-annual', 'name' => 'Patungan Tahunan', 'description' => 'Akses penuh Cooca selama 365 hari.', 'price' => 250000, 'duration_days' => 365, 'token_quantity' => null, 'storage_bytes' => null, 'token_expiry_days' => null, 'is_active' => true, 'sort_order' => 2, 'created_at' => $now, 'updated_at' => $now],
